...
import type { Fleet, UpdateFleetRequest } from "@/types/api";
...
export const EditFleetModal = ({
  ...
  const [formData, setFormData] = useState<UpdateFleetRequest>({
    name: fleet.name,
    description: fleet.description,
    manager: fleet.manager,
    managerEmail: fleet.managerEmail,
    managerPhone: fleet.managerPhone,
    status: fleet.status,
  });
  ...
  const updateMutation = useMutation({
    mutationFn: (data: UpdateFleetRequest) =>
      fleetApi.updateFleet(fleet.id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["fleet", fleet.id] });
